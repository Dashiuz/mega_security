...
export default function SectionPorQueElegirnos() {
  ...
  return (
    <section
      ...
      className="w-full bg-mega-black py-24 md:py-32 relative z-20 border-t border-white/5"
    >
      <div className="container mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div className="mb-20 text-left">
          ...
          <p className="mt-8 text-xl text-mega-silver font-light max-w-2xl leading-relaxed">
            Un proceso claro, sin sorpresas. Porque la confianza se
            <br /> construye desde el primer contacto.
          </p>
        </div>
        ...
        >
          ...
          <div className="relative inline-block w-full sm:w-auto">
            <button
              ...
              className="btn-premium-cta group relative overflow-hidden px-8 py-4 text-base font-medium rounded-sm w-full sm:w-[320px] flex items-center justify-between z-20"
            >
